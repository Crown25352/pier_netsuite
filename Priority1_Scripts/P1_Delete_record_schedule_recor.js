...
define(['N/runtime', 'N/search', 'N/record'], function(runtime, search, record) {
	...
	function getInputData() {
		...
		/**** Search on Schedule Record Start ****/
		var scheduleVal;
			var customrecord_SearchObj_schedule = search.create({
			   type: "customrecord_p1_schedule_record",
			   filters:
			   [
				  ["created","within","lastyear"]//  "2/6/2022 12:00 am","2/21/2022 11:59 pm"
			   ],
			   columns:
			   [
			 ...
			 //var searchResultCount = customrecord_SearchObj_schedule.runPaged().count;
			 var searchResultCount = customrecord_SearchObj_schedule.runPaged().count;
			 log.debug("customrecord_SearchObj_schedule result count schedule",searchResultCount);
			
		/**** End ****/
		
		 return customrecord_SearchObj_schedule;
