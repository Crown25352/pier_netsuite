        ...
        function htmlBookingsReportBody(reportEndingDate, totalMonthWorkDays, mtdWorkDays, fullMonthBudget){
            ...
            salesorderSearchObj.run().each(function(result){  
                ...
                if(mtdAvg != 0){   
                    ...
                    log.debug('mtdAvg', mtdAvg);
                    log.debug('runRateBookings', runRateBookings);
                    log.debug('mtdWorkDays', mtdWorkDays);
                    log.debug('totalMonthWorkDays', totalMonthWorkDays);
                }
                ...
                if(mtdBudget && mtdBookings != 0){                    
                    ...
                    varAmountVsAct = (mtdBudget - mtdBookings)/mtdBudget;
            ...
            if(mtdBudget && totalMtdBookings != 0){                    
                ...
                totalVarAmountVsAct = (mtdBudget - totalMtdBookings)/mtdBudget;
        ...
        function htmlShipmentsReportBody(reportEndingDate, totalMonthWorkDays, mtdWorkDays, fullMonthBudget){
            ...
            salesorderSearchObj.run().each(function(result){
                ...
                if(mtdBudget && mtdShipments != 0){                    
                    ...
                    varAmountVsAct = (mtdBudget - mtdShipments)/mtdBudget;
            ...
            if(mtdBudget && totalMtdShipments != 0){                    
                ...
                totalVarAmountVsAct = (mtdBudget - totalMtdShipments)/mtdBudget;
