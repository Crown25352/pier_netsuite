        ...
        function htmlBookingsReportBody(reportEndingDate, totalMonthWorkDays, mtdWorkDays, fullMonthBudget){
            ...
            salesorderSearchObj.run().each(function(result){  
                ...
                var salesorderSearchObj = search.create({
                    ...
                    columns:
                    [
                        search.createColumn({name: "formulacurrency", summary: "SUM", formula: "CASE WHEN {status} = 'Pending Fulfillment' THEN ROUND({amount}/1000,2) ELSE 0 END", label: "Past Due"})
                    ]
                });
                ...
                //if(mtdBudget && mtdBookings != 0){              
                if(mtdBudget && mtdBookings >= 1){                    
                    varPercentageVsAct = ((mtdBudget - mtdBookings)/mtdBudget)*100;
                    varAmountVsAct = (mtdBudget - mtdBookings);
            ...
            log.debug('totalBookings', totalBookings);
